...
extern OB::TypeCodeConst _tc_Hello;
...
void operator<<=(::CORBA::Any&, Hello_ptr*);
void operator<<=(::CORBA::Any&, Hello_ptr);
CORBA::Boolean operator>>=(const ::CORBA::Any&, Hello_ptr&);

inline void
operator<<=(::CORBA::Any_var& any, Hello_ptr* val)
{
    any.inout() <<= val;
}
...
operator>>=(const ::CORBA::Any_var& any, Hello_ptr& val)
{
    return any.in() >>= val;
}
